...
from app.dpendencies.dpendencies import get_upload_service, get_chat_service,get_history_service
...
async def upload(file: UploadFile = File(...),
    ...
    return StreamingResponse(
        upload_service.upload_stream(file),
...
async def get_history(history_service:HistoryService = Depends(get_history_service)):
